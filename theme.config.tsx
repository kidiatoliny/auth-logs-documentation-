...
const config: DocsThemeConfig = {
  ...
  project: {
    link: 'https://github.com/akira-io/laravel-auth-logs',
  },
  ...
  docsRepositoryBase: 'https://github.com/akira-io/laravel-auth-logs/tree/main/docs',
  ...
  head: () => {
    ...
    const url = `https://authlogs.akira-io.com${defaultLocale === locale ? asPath : `/${locale}${asPath}`}`.replace(/\/$/, '') + '/';

    return (
      <>
        <meta property='og:url' content={url} />
        <meta property='og:title' content={frontMatter.title || 'Auth Logs'} />
        <link rel='icon' href='/favicon.ico' />
        <meta
          property='og:description'
          content={frontMatter.description || 'Laravel Auth Documentation'}
        />
      </>
    );
  },
